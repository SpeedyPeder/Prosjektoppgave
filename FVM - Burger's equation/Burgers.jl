...
BurgersSim.burgers_compare_at(N, L, T; CFL, method=:muscl, limiter=:superbee,     show_analytic=true, savepath="muscl_superbee.png")
BurgersSim.burgers_compare_at(N, L, T; CFL, method=:muscl, limiter=:vanleer, show_analytic=true, savepath="muscl_vanleer.png")
